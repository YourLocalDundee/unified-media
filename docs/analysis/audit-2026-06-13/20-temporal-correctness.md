...
- Severity: High
- Files: `src/lib/media-server/library.ts:139-154` and `:105-137`; `src/app/api/the old media server/continue-watching/route.ts:43-122`; writer evidence `src/components/media/VideoPlayer.tsx:342,363`
