# Audit 06 — Requests Lifecycle (the old request app-style)
...
Scope: native request system that replaces the old request app requests. Pages `src/app/requests/*`, API
