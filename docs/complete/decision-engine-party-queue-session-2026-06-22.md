...
Two-stage release evaluation in the grabber, like the external automation services: **hard gates** decide what is grabbable
...
From retired design notes, now that Tier-1 #1/#2/#3 are shipped: upgrade-until-cutoff + proper/repack
