...
- Shape returned:
  ...
  { "iceServers": [
      ...
      { "urls": ["turn:<turn-host>:3478?transport=udp",
...
3. DNS: Pi-hole/host record `<turn-host>` → the edge host. For off-tailnet reachability the
...
- App container: `TURN_AUTH_SECRET`, `TURN_HOST=<turn-host>`, `TURN_PORT=3478`,
