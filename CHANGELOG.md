...
- **`SUBTITLE_MEDIA_ROOT=/media`** added to `.env.local` — required for the subtitle downloader to write `.srt` files alongside media files using the old media server naming convention.
