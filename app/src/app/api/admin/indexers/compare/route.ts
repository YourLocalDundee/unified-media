// Head-to-head indexer comparison. Read-only against indexer health (see compare.ts:
// neither side records backoff/rate-limit state), but still admin-gated since it drives
// real outbound requests using the target indexer's api_key.
