 ...
 * No server-side data fetch here; UMT preferences are loaded client-side
...
// Admin-only: UMT preferences are download infrastructure. Non-admins are redirected home
