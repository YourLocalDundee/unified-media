...
export function runMigrations(db: Database.Database): void {
  ...
  // indexers.name was never actually unique — catalog seeding and every manual "Add Indexer"
  // call use INSERT OR IGNORE / rely on a name collision to avoid duplicates, but no constraint
  // ever enforced one (caught 2026-07-11: a discovery re-run silently double-inserted
  ...
  // Seed canonical quality tiers (weight follows the standard release-quality ladder)
