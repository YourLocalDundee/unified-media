...
// and queried via the Torznab XML protocol directly — no external indexer
// manager involved.
...
export interface IndexerDefinition {
  name: string
  description: string
  search_type: string   // 'torznab' or an adapterRegistry key (index.ts) — e.g. 'yts', 'eztv', 'nyaa', 'knaben'
  base_url: string
