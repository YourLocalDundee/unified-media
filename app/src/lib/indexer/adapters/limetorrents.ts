...
// search results page, so this needs no detail-page hop (we just want the hash, which is
// cheaper to get directly than a .torrent URL off the detail page). Confirmed live 2026-07-12.
