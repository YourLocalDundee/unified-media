...
// Archive.org doesn't expose real per-item seeder/leecher counts via this API — its own seed
// infrastructure guarantees availability, so the hardcoded 1/1 here signals "known seeded",
// not a literal swarm count.
