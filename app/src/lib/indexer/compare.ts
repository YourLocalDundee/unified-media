// Head-to-head comparison of two indexers (e.g. a native adapter vs a plain Torznab row for the
// same tracker) run independently, with no merge/dedup — evidence for deciding which of two
// sources for the same tracker to keep enabled.
