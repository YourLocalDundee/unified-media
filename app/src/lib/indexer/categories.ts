// Newznab/Torznab standard category tree — a fixed, indexer-agnostic
// set of IDs every Torznab endpoint already understands and normalizes its own tracker
// categories into. Kept to the subset that matters at home-server scale rather than
// carrying the full standard category list.
