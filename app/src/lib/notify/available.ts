 ...
 * (automation/availability.ts) and the importer's three import routes (automation/importer.ts).
 * Routing all of them through this one helper keeps the notification
