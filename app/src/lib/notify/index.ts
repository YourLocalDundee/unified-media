 ...
 * (the availability cron's approved -> available transition, or an importer path —
 * whichever flips the row first; the status guard on each path dedupes so only one notifies).
 *
