 ...
 *
 * This is Phase 3 of the independence build — approved requests flow straight into the
 * native automation layer here, with no external request or automation services involved.
 */
