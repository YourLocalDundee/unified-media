...
release_group | size | flag`, scored within `autoPickScore`. Full gate table, blocklist/reaper
behavior, and the custom-format spec types are in `docs/features/decision-engine.md`.
